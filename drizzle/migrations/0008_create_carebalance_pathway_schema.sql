...
care_requests: Hospital discharge / care request. Created by hospital staff.
care_evaluations: Evaluation performed by home care service after receiving request.
care_plans: Personalized care plan built from evaluation.
pathway_steps: The 15-step CareBalance pathway timeline for each care request.
pathway_history: Audit log for all pathway actions.
transmissions: Professional-to-professional communications about a patient.
family_notifications: Notifications sent to family members about care events.
documents: Documents attached to a patient or care request.
...
-- Grants
-- ============================================================
GRANT SELECT, INSERT, UPDATE, DELETE ON care_requests TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON care_evaluations TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON care_plans TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON pathway_steps TO authenticated;
GRANT SELECT, INSERT ON pathway_history TO authenticated;
GRANT SELECT, INSERT, UPDATE ON transmissions TO authenticated;
GRANT SELECT, INSERT, UPDATE ON family_notifications TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON documents TO authenticated;
GRANT ALL ON care_requests TO service_role;
GRANT ALL ON care_evaluations TO service_role;
GRANT ALL ON care_plans TO service_role;
GRANT ALL ON pathway_steps TO service_role;
GRANT ALL ON pathway_history TO service_role;
GRANT ALL ON transmissions TO service_role;
GRANT ALL ON family_notifications TO service_role;
